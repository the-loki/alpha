...
describe('[domain] isPermissionLevel', () => {
...
describe('[domain] levelDescriptionKey', () => {
...
describe('[domain] the decision table', () => {
...
describe('[domain] deciding a call', () => {
  const base = {
    toolName: 'bash',
    args: { command: 'ls -la' },
    conversationId: 'c1',
...
describe('[domain] matching a rule', () => {
