...
describe('[domain] parseConversationIndex', () => {
...
describe('[domain] listForWorkspace', () => {
...
describe('[domain] upsertConversation', () => {
...
describe('[domain] removeConversation', () => {
...
describe('[domain] findConversation', () => {
  it('finds by id', () => {
