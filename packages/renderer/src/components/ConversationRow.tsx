...
function RowActions({
  ...
  return (
    <span ref={container} className="absolute inset-y-0 right-0">
      <span className="flex h-full items-center rounded-control bg-ink-600 pr-1 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100">
        <button
          type="button"
          ...
          className="grid h-5 w-5 place-items-center rounded-control text-parchment-dim transition-colors hover:text-parchment"
        >
          <MoreIcon />
        </button>
      </span>
