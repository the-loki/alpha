...
ENTRIES: list[tuple[str, str, str]] = [
    ...
    (
        'composer.attachmentNoVision',
        '{model} does not take pictures. Turn that on for it under Models in Settings.',
        '{model} 不能看图。可以在"设置 → 模型"里为它打开。',
    ),
    ...
    ('settings.takesPictures', 'Takes pictures', '可以看图'),
